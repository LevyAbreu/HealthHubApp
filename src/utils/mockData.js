...
export const PROFILE_DATA = {
  ...
  conquistas: [
    { id: '1', name: 'A todo vapor', desc: '30 dias seguido', icon: 'fire', color: '#FF4D4D', bg: '#FFEBEB', locked: false },
    { id: '2', name: 'Hidratada', desc: 'Meta batida', icon: 'water', color: '#0EA5E9', bg: '#E0F2FE', locked: false },
    { id: '3', name: 'Madrugadora', desc: 'Treino às 6h', icon: 'weather-sunset-up', color: '#6366F1', bg: '#EEF2FF', locked: false },
    { id: '4', name: 'Maratonista', desc: 'Corra 42km', icon: 'run', color: '#94A3B8', bg: '#F1F5F9', locked: true },
    { id: '5', name: 'Mestre Zen', desc: '7 dias meditando', icon: 'leaf', color: '#94A3B8', bg: '#F1F5F9', locked: true },
  ],
  performance: [
