  ...
  return (
    <View style={styles.container}>
      <View style={styles.fixedHeader}>
          <Header title="Sono" navigation={navigation} />
      </View>
        ...
        <Card style={styles.summaryCard}>
          <View style={styles.summaryRow}>
            <View style={styles.statsContainer}>
              ...
              <View style={styles.statItem}><Text style={styles.statLabel}>Realizado</Text><Text style={styles.statValue}>5h</Text></View>
              <View style={styles.statItem}><Text style={styles.statLabel}>Faltou</Text><Text style={styles.statValue}>3h</Text></View>
              <View style={styles.statItem}><Text style={styles.statLabel}>Meta</Text><Text style={styles.statValue}>8h</Text></View>
            </View>
            <View style={styles.progressCircle}>
              <MaterialCommunityIcons name="bed" size={45} color="#3498db" />
            </View>
          </View>
        </Card>
