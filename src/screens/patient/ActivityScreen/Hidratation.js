...
export default function HidratationScreen({ navigation }) {
  return (
    <View style={styles.container}>
      <View style={styles.fixedHeader}>
          <Header title="Hidratação" navigation={navigation} />
      </View>
          ...
          <View style={styles.summaryRow}>
            <View style={styles.statsContainer}>
              ...
              <View style={styles.statItem}>
                ...
                <Text style={styles.statValue}>0.5L</Text>
              </View>
            ...
            <View style={styles.chartWrapper}>
               <View style={styles.progressCircle}>
                  <MaterialCommunityIcons name="water" size={45} color="#3498db" />
               </View>
            </View>
          </View>
        </Card>
...
const styles = StyleSheet.create({
  ...
  chartWrapper: { width: 120, height: 120, justifyContent: 'center', alignItems: 'center' },
  ...
  insertButton: { backgroundColor: '#3498db', borderRadius: 15, paddingVertical: 12, alignItems: 'center', marginTop: 20, marginBottom: 25 },
  insertButtonText: { color: '#FFF', fontWeight: 'bold', fontSize: 16 },
  sectionTitle: { fontSize: 16, fontWeight: 'bold', marginBottom: 15 },
  historyCard: { backgroundColor: '#FFF', borderRadius: 25, minHeight: 400, marginBottom: 30 },
  emptyHistory: { flex: 1 }
});